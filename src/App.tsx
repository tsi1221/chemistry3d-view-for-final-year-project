...
const grade9Lessons: Omit<Item, 'grade'>[] = [
  ...
  // ---------- PHYSICS (Grade 9) ----------
  { name: "Definition and Nature of Physics", link: "/grade9/physics/chapter1/Definition and Nature of Physics.html", chapter: "Chapter 1: Foundations", subject: "Physics" },
  { name: "Figure 3 - Physics Concept", link: "/grade9/physics/chapter1/Physics · Thought Experiments.html", chapter: "Chapter 1: Foundations", subject: "Physics" },
  { name: "Physics Branch Explorer", link: "/grade9/physics/chapter1/Physics Branch Explorer.html", chapter: "Chapter 1: Foundations", subject: "Physics" },
  { name: "Mark Density - Mechanics", link: "/grade9/physics/chapter2/Precision Lab · Mark Density.html", chapter: "Chapter 2: Mechanics", subject: "Physics" },
  { name: " Multi-Device.html", link: "/grade9/physics/chapter2/Precision Lab · Multi-Device.html", chapter: "Chapter 2: Mechanics", subject: "Physics" },
  { name: "Subjective vs Objective", link: "/grade9/physics/chapter2/Measurement Lab · Subjective vs Objective.html", chapter: "Chapter 2: Mechanics", subject: "Physics" },
  { name: "Scientific Notation", link: "/grade9/physics/chapter2/Scientific Notation · Decimal Slider.html", chapter: "Chapter 2: Mechanics", subject: "Physics" },
  { name: "Sig Fig Lab · Uncertainty Filter", link: "/grade9/physics/chapter2/Sig Fig Lab · Uncertainty Filter.html", chapter: "Chapter 2: Mechanics", subject: "Physics" },
